...
//---------------POODLL VIDEO FORUM PATH START-------------------
if(!empty($_POST['saveflvvoice'])){
	...
	if ($fromform->saveflvvoice) 
	{
		...
		$fullpath = $fromform->saveflvvoice;

		//updated to use new filter justin 20091011
		//$toFilterText = '{FMS:VIDEO='.$fullpath.'}';
	    ...
	    $fromform->format   = 0;
	    $fromform->message  = $toFilterText .'<br />'.$fromform->message;
	}
}
//---------------VIDEO FORUM PATH END---------------------
