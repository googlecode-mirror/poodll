...
<p>
<?php print_string('freeplayinstructions', 'poodllflashcard'); ?>.
</p>
                ...
                <tr>
                    <td align="center" valign="center">
                        ...
                        if ($flashcard->questionsmediatype == FLASHCARD_MEDIA_IMAGE) {
                            poodllflashcard_print_image($flashcard, $subquestion->questiontext);
                        } elseif ($flashcard->questionsmediatype == FLASHCARD_MEDIA_SOUND){                            
                            poodllflashcard_play_sound($flashcard, $subquestion->questiontext, 'false', false, "bell_f$i");
                            ...
                            echo "<br/>";
                            poodllflashcard_play_sound($flashcard, $sound, 'false', false, "bell_f$i");
                        } else {
...
?>
            ...
            <table width="100%" height="100%">
                <tr>
                    <td align="center" valign="middle" class="emptyset">
                        <?php print_string('emptyset', 'poodllflashcard'); ?>
                    </td>
                </tr>
            </table>
            </div>
    ...
    <tr>
        <td width="200px">
            <input id="next" type="button" value="<?php print_string('next', 'poodllflashcard') ?>" onclick="javascript:next()" />
        </td>
    </tr>
    <tr>
        <td width="200px">
            <input id="previous" type="button" value="<?php print_string('previous', 'poodllflashcard') ?>" onclick="javascript:previous()" />
        </td>
    </tr>
    <tr>
        <td width="200px">
            <input id="remove" type="button" value="<?php print_string('removecard', 'poodllflashcard') ?>" onclick="javascript:remove()" />
        </td>
    </tr>
    <tr>
        <td width="200px">
            <input type="button" value="<?php print_string('reset', 'poodllflashcard') ?>" onclick="javascript:location.reload()" />
        </td>
    </tr>
    <tr>
        <td width="200px" align="center" colspan="2">
            <br/><a href="<?php echo $CFG->wwwroot ?>/course/view.php?id=<?php echo $course->id ?>"><?php print_string('backtocourse', 'poodllflashcard') ?></a>
        </td>
      </tr>
</table>
