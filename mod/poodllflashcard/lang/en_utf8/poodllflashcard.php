...
$string['backtocourse'] = 'Home';
$string['backtodecks'] = 'Back to the start';
...
$string['customisation'] = 'To customize this instance of PoodLL Flashcard, get the stylesheet beneath, <br/>edit it and save it within the <a href=\"$a\">moddata/poodllflashcard</a>/&lt;<i>instance</i>&gt; directory in the course\'s files.<br/> If you use images as background, save them in the same place, and invoke them with their simple names';
$string['deck'] = 'Deck';
...
$string['freeplayinstructions'] = 'Check your answers.  The cards are random.';
...
$string['instructions'] = 'Click on the card to see the cnswer';
...
$string['undefinedquestionset'] = 'No matching question was elected in quizzes for this PoodLL Flashcard set';
