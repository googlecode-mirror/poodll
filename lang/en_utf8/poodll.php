...
//$string['buffer'] = 'Buffer Size (seconds)';
//$string['autostart'] = 'Auto Start Media Player?';
//$string['allowfs'] = 'Allow Full Screen?';
//$string['repeat'] = 'Repeat Play?';
...
//for the html editor to use as poodll palette title
$string['insertpoodllwidget'] = 'Insert PoodLL Widget';
